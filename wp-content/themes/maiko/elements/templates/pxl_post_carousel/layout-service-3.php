    ...
    <?php if (is_array($posts)): ?>
        <div class="pxl-swiper-slider pxl-service-carousel pxl-service-carousel3 pxl-service-style1 <?php echo esc_attr($settings['service_style_l1']); ?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'maiko'); ?>"<?php endif; ?>>
            <?php if($arrows !== false): ?>

    ...
    <?php if (is_array($posts)): ?>
        <div class="pxl-swiper-slider pxl-service-carousel pxl-service-carousel4 pxl-service-style1 <?php echo esc_attr($settings['service_style_l1']); ?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'maiko'); ?>"<?php endif; ?>>
                        ...
                        foreach ($posts as $post):
                            ...
                            <div class="pxl-swiper-slide">
                                <div class="pxl-post--inner  <?php echo esc_attr($pxl_animate); ?>">
                                            ...
                                            <div class="pxl-post--readmore">
                                                <a class="btn-readmore" href="<?php if(!empty($service_external_link)) { echo esc_url($service_external_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>">
                                                    <span><?php if(!empty($button_text)) {
                                                        ...
                                                        echo esc_html__('view more', 'maiko');
                                                    } ?></span>
                                    ...
                                    <div class="pxl-image" style="background-image:url(<?php echo esc_url($thumbnail_url); ?>);">

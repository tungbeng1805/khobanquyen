...
<div class="pxl-counter pxl-counter3 <?php echo esc_attr($settings['pxl_animate'].' '.$settings['style-l3']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">

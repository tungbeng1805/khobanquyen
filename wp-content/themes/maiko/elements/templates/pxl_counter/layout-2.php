    ...
    <div class="pxl-counter--inner">
        <div class="pxl-counter--holder ">
            ...
            <div class="pxl-counter--number ">
                <span class="pxl-counter--prefix <?php echo esc_attr($settings['custom_font']); ?> el-empty"><?php echo pxl_print_html($settings['prefix']); ?></span>
                ...
                <?php if(!empty($settings['suffix'])) : ?>
                    <span class="pxl-counter--suffix <?php echo esc_attr($settings['custom_font']); ?>"><?php echo pxl_print_html($settings['suffix']); ?></span>
                <?php endif; ?>
            </div>

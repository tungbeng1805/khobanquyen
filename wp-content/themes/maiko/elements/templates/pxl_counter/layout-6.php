...
<div class="pxl-counter pxl-counter6 <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-counter--inner">
        <div class="pxl-counter--holder ">
            ...
            <div class="pxl-counter--number ">
                <p class="pxl-counter--prefix el-empty"><?php echo pxl_print_html($settings['prefix']); ?></p>
                <p <?php pxl_print_html($widget->get_render_attribute_string( 'counter' )); ?>><?php echo esc_html($settings['starting_number']); ?></p>
                <?php if(!empty($settings['suffix'])) : ?>
                    <p class="pxl-counter--suffix"><?php echo pxl_print_html($settings['suffix']); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="pxl-counter--content">
                <?php echo pxl_print_html($settings['content']); ?>
            </div>
            <span></span>
        </div>
    </div>

...
if(isset($settings['text4']) && !empty($settings['text4']) && count($settings['text4'])): ?>
    <div class="pxl-swiper-slider pxl-text-carousel pxl-text-carousel4 <?php echo esc_attr($settings['style']); ?>" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_html('DRAG', 'maiko'); ?>"<?php endif; ?>>

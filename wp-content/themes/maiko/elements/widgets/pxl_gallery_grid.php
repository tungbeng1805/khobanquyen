...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Gallery Grid', 'maiko'),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'padding_top',
                                    'label' => esc_html__('Padding Top', 'maiko' ),
                                    'type' => \Elementor\Controls_Manager::SLIDER,
                                    'control_type' => 'responsive',
                        ...
                        array(
                            'name' => 'grid_sizer',
                            'label' => esc_html__('Grid Sizer', 'maiko' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'description' => 'Default: 50%',
                            'range' => [
                        ...
                        array(
                            'name' => 'img_size_popup',
                            'label' => esc_html__('Image Size Popup', 'maiko' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'description' => 'Enter image size (Example: "thumbnail", "medium", "large", "full" or other sizes defined by theme). Alternatively enter size in pixels (Example: 200x100 (Width x Height).',
                        ),
                        array(
                            'name' => 'item_width_all',
                            'label' => esc_html__('Items Width', 'maiko' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'description' => 'Default: 50%',
                            'range' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Items Padding Top', 'maiko' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'description' => 'Default: 55%',
                            'range' => [

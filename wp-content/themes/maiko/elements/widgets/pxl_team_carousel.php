...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Team Carousel', 'maiko'),
        ...
        'params' => array(
            'sections' => array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'item_link',
                                    'label' => esc_html__('Link Details', 'maiko'),
                                ...
                                array(
                                    'name' => 'icon_label',
                                    'label' => esc_html__('Icon Label', 'maiko'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                ),
                                array(
                                    'name' => 'icon_link',
                                    'label' => esc_html__('Icon Link', 'maiko'),
                                    'type' => \Elementor\Controls_Manager::URL,
                                    'label_block' => true,
                                ),
                            ),
                ...
                array(
                    ...
                    'label' => esc_html__('Carousel Settings', 'maiko'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'color_dot',
                            'label' => esc_html__('Color Dot', 'maiko' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'color_dotat',
                            'label' => esc_html__('Color Dot Active', 'maiko' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [

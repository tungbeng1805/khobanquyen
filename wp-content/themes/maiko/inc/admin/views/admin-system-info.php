<?php 
	...
	function pxl_get_system_info() {
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Upload max file size (64MB)', 'maiko' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Memory limit (256MB)', 'maiko' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Post max size (64MB)', 'maiko' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Max Execution Time (6s)', 'maiko' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Max input vars (3000)', 'maiko' ),
	...
	?>
		<div class="pxl-iconbox">
			<div class="pxl-icon-container">
				<?php if ( $item['status'] ) : ?>
					<img src="<?php echo get_template_directory_uri() . '/inc/admin/assets/img/check.png' ?>" alt="<?php esc_attr_e( 'Check', 'maiko' ); ?>">
				<?php else : ?>
					<img src="<?php echo get_template_directory_uri() . '/inc/admin/assets/img/crossed.png' ?>" alt="<?php esc_attr_e( 'Un Check', 'maiko' ); ?>">
				<?php endif; ?>
			</div>

...
class MongoDBFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSimpleFormat()
    {
        ...
        $this->assertEquals('0.0a111900 1391212800', $formattedRecord['datetime']->__toString());
    ...
    public function testRecursiveFormat()
    {
        ...
        $this->assertEquals('0.0a111900 1391221893', $formattedRecord['context']['stuff']->__toString());
        $this->assertEquals(
            array(
                'foo' => 'something',
                'bar' => 'stuff',

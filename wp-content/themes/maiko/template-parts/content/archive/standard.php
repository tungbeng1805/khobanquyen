...
$archive_readmore_text = maiko()->get_theme_opt('archive_readmore_text', esc_html__('find out more', 'maiko'));
...
<article id="post-<?php the_ID(); ?>" <?php post_class('pxl-archive-post'); ?>>
    <div class="content-inner-post">
        <?php if (has_post_thumbnail()) {
            $archive_date = maiko()->get_theme_opt( 'archive_date', true );
            ?>
                        ...
                        <div class="quote-inner">
                            <div class="content-top">
                             ...
                             <div class="content-right">
                                <?php maiko()->blog->get_archive_meta_2(); ?>
            ...
            if (has_post_thumbnail()) {
                ...
                <div class="format-wrap">
                    <div class="pxl-item--image">
                        <a href="<?php echo esc_url( get_permalink()); ?>"><?php the_post_thumbnail('maiko-large'); ?></a>
                        <?php
...
if (!has_post_format('link') && !has_post_format('quote')){
    ...
    <div class="post-content">
        ...
        <div class="post-bottom">
            <?php maiko()->blog->get_archive_meta_v2(); ?>
            <?php

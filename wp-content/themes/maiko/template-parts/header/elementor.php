<?php 
$logo_m = maiko()->get_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$p_menu = maiko()->get_page_opt('p_menu');
$header_mobile = maiko()->get_page_opt('header_mobile', 'show');
$header_display = maiko()->get_page_opt('header_display', 'show');
$sticky_scroll = maiko()->get_opt('sticky_scroll');
$pm_menu = maiko()->get_theme_opt('pm_menu');
...
$opt_mobile_style = maiko()->get_opt('opt_mobile_style');
$mobile_display = maiko()->get_opt('mobile_display');
$header_mobile_layout = maiko()->get_opt('header_mobile_layout');
$header_mobile_layout_count = (int)maiko()->get_opt('header_mobile_layout');
                ...
                <div class="row">
                    ...
                    <div class="pxl-header-menu">
                        <div class="pxl-header-menu-scroll">
                            ...
                            <?php maiko_header_mobile_search_form(); ?>

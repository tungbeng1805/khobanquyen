...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'portfolioPartialsTraceIgnore' => array('Monolog\\'), // array Hide calls of portfolio started with...
    ...
    private function handleDebugRecord(array $record)
    {
        ...
        $this->connector->getDebugDispatcher()->dispatchDebug($message, $tags, $this->options['portfolioPartialsTraceIgnore']);
    }
    ...
    private function handleErrorRecord(array $record)
    {
        ...
        $this->connector->getErrorsDispatcher()->dispatchError(
            ...
            $this->options['portfolioPartialsTraceIgnore']
        );
    }

...
class Icoland_Admin_Plugins extends Icoland_Admin_Page {
	protected $id = null;
	...
	public function __construct() {
		...
		$this->page_title = esc_html__( 'Install Plugins', 'icoland' );
		$this->menu_title = esc_html__( 'Install Plugins', 'icoland' );
		$this->parent = 'pxlart';
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
				$btn_class = 'white';
				$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'icoland' );
			...
			case 'installed':
				$btn_class = 'success';
				$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'icoland' );
			...
			case 'active':
				$btn_class = 'danger';
				$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'icoland' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'icoland' );

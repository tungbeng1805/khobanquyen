...
if(isset($settings['history']) && !empty($settings['history']) && count($settings['history'])): ?>
    <div class="pxl-swiper-sliders pxl-history-carousel pxl-history-carousel1 <?php echo esc_attr($settings['style']); ?>" data-view-auto="<?php echo esc_attr($col_xl); ?>" data-show-arrow="<?php echo esc_attr($arrows); ?>">

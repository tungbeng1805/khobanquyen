...
if(isset($settings['history_2']) && !empty($settings['history_2']) && count($settings['history_2'])): ?>
    <div class="pxl-swiper-sliders pxl-history-carousel pxl-history-carousel4 <?php echo esc_attr($settings['style']); ?>" data-view-auto="<?php echo esc_attr($col_xl); ?>" data-show-arrow="<?php echo esc_attr($arrows); ?>">
        <div class="pxl-carousel-inner">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php foreach ($settings['history_2'] as $key => $value):
                            ...
                            <div class="corner-box">
                                <div class="pxl-item--inner  <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                                    <div class="pxl-item--holder">
                                        ...
                                        <?php if(!empty($list)):
                                            $list_ct = json_decode($list, true);
                                            foreach ($list_ct as $value): ?>

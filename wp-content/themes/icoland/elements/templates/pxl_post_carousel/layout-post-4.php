...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-post-carousel pxl-post-carousel4 pxl-swiper-boxshadow <?php echo esc_attr($settings['style1']); ?>">
        <div class="pxl-carousel-inner">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php
                    $image_size = !empty($img_size) ? $img_size : '450x224';
                    foreach ($posts as $post):
                        ...
                        <div class="pxl-swiper-slide">
                            ...
                            <div class="content-bottom">
                                <div class="pxl-item--categorie"><?php the_terms( $post->ID, 'category' ); ?></div>
                            ...
                            <div class="pxl-item--author">
                                <a class="image-author" href="<?php echo esc_url(get_author_posts_url($post->post_author, $author->user_nicename)); ?>">
                                    <?php echo get_avatar( $user_id, 'full' ) ; ?>
                                </a>
                                <div class="pxl-item--meta ">
                                    <div class="name" ><?php echo esc_html($author->display_name); ?></div>                                         
                                    <div class="date"><?php $date_formart = get_option('date_format'); echo get_the_date('F d,Y', $post->ID); ?></div>    
                                </div>
                            </div>
                        </div>
                    </div>

<div class="pxl-icon-box pxl-icon-box9 <?php echo esc_attr($settings['t-align']); ?> <?php echo esc_attr($settings['style']); ?> <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">

...
if(isset($settings['pxl_chart']) && !empty($settings['pxl_chart']) && count($settings['pxl_chart'])): ?>
    <div class="pxl-chart pxl-chart-2" type_canvas='<?php echo esc_attr($settings['pxl_chart_type']); ?>'  cutout='<?php echo esc_attr($settings['width_chart']); ?>'>
        ...
        <div class="lengend">
            <?php foreach ($settings['pxl_chart'] as $key => $value):
                ...
                <div class="list-content">
                    ...
                    <span class="value"><?php echo pxl_print_html($chart_value); ?>%</span>
                </div>
            <?php endforeach; ?>
        </div>
    </div>

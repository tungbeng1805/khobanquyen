...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('TN Product Carousel ', 'icoland' ),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'source',
                            'label' => esc_html__('Select Categories', 'icoland' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'style_scroll',
                            'label' => esc_html__('Scroll', 'icoland' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'style-1' => 'Right To Left',
                                'scroll-ltr' => 'Left To Right',
                            ],
                            'default' => 'style-1',
                            'condition' => [
                                'autoplay' => 'true'
...
array(
    ...
    'controls' => array(
        array(
            'name' => 'style',
            'label' => esc_html__('Style Layout', 'icoland' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'style-1' => 'Style 1',
                'style-2' => 'Style 2',

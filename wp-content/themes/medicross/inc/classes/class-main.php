...
if (!class_exists('Medicross_Main')) { 
    class Medicross_Main extends Medicross_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Medicross_Main();
            }
...
function medicross() {
    return Medicross_Main::getInstance();
}
// Install
medicross(); 

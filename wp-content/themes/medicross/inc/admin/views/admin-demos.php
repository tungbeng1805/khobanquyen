<main>
	...
	<div class="pxl-dashboard-wrap">
		...
		elseif( !empty($plugin_requires) && sizeof($plugin_requires) >= 1 ):
			...
			echo '<div class="error"><p>';
			echo sprintf( wp_kses_post( esc_html__( 'Make sure to activate required plugins prior to import a demo.', 'medicross' ) ), medicross()->get_name(), '<a class="nt-atpli" href="' . admin_url( 'admin.php?page=pxlart-plugins') . '">' , '</a>' ) . '</p>';
		...
		<header class="pxl-dsb-header">
			<div class="pxl-dsb-header-inner">
				<h4><?php esc_html_e( 'Import a Demo', 'medicross' ); ?></h4>
				<p><?php esc_html_e( 'Choose a pre-built website for starting a quick design process.', 'medicross' ) ?></p>
			</div>
			<div class="pxl-msg pxl-dsb-notice">
				<p><span><?php esc_html_e( 'Note:', 'medicross' ); ?></span> <?php esc_html_e( 'Make sure to activate required plugins prior to import a demo.', 'medicross' ) ?></p>
			</div>
		</header>
							...
							<figure>
								...
								<div class="pxl-btn-group">
									...
									<a target="_blank" href="<?php echo esc_url( $demo['preview'] ); ?>" class="pxl-preview-btn">
										<span><?php esc_html_e( 'Preview Demo', 'medicross' ); ?></span>
		...
		<script type="text/template" id="tmpl-demo-import-modules">
			<div id="pxl-progress-popup" class="pxl-imp-popup-wrap is-active">
				<div class="pxl-imp-progress">
					<h6><?php esc_html_e( 'Importing...', 'medicross' ); ?></h6>
					<div id="pxl-progress" class="importing"><?php esc_html_e( 'Working', 'medicross' )?> <span>.</span><span>.</span><span>.</span></div>
					<div class="pxl-progressbar">
						<div class="pxl-progressbar-inner" style="width: 0%">
							<span id="pxl-loader" class="pxl-progressbar-percentage"><?php esc_html_e( '0%', 'medicross' ); ?></span>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="pxl-popup" class="pxl-imp-popup-wrap is-active">
				<div class="pxl-imp-popup-inner">
					...
					<div class="pxl-imp-popup-content">
						<h4 style="text-align:center; margin-bottom: 30px;"><?php esc_html_e( 'Select all or a few', 'medicross' ); ?></h4>
						<div class="pxl-row">
							<div class="pxl-col pxl-col-6">
								<span class="pxl-imp-opt">
									...
									<span><?php esc_html_e( 'Media Attachments', 'medicross' ); ?></span>
								</span>
							</div>
							<div class="pxl-col pxl-col-6">
								<span class="pxl-imp-opt">
									...
									<span><?php esc_html_e( 'Content', 'medicross' ); ?></span>
								</span>
							</div>
							<div class="pxl-col pxl-col-6">
								<span class="pxl-imp-opt">
									...
									<span><?php esc_html_e( 'Theme Options', 'medicross' ) ?></span>
								</span>
							</div>
							<div class="pxl-col pxl-col-6">
								<span class="pxl-imp-opt">
									...
									<span><?php esc_html_e( 'Widgets', 'medicross' ); ?></span>
								</span>
							</div>
							...
							<div class="pxl-col pxl-col-6">
								<span class="pxl-imp-opt">
									...
									<span><?php esc_html_e( 'Revslider', 'medicross' ); ?></span>
								</span>
							</div>
 							<?php endif; ?>
							<div class="pxl-col pxl-col-6">
								<span class="pxl-imp-opt">
									...
									<span><?php esc_html_e( 'Settings', 'medicross' ) ?></span>
								</span>
							</div>
						</div>
							...
							<div class="pxl-col pxl-col-12">
								<div class="pxl-imp-skip-posts">
									<span class="pxl-imp-opt-skip-posts" style="margin-bottom: 0; padding-left: 15px;">
										...
										<span><?php esc_html_e( 'Skip the posts exist. By default, all current content will be deleted.', 'medicross' ); ?></span>
										</label>
									</span>
								</div>
								<div class="pxl-imp-crop">
									<span class="pxl-imp-opt-crop" style="margin-bottom: 0; padding-left: 15px;">
										...
										<label for="pxl-imp-crop-img">
											<span><?php esc_html_e( 'Crop Image after import finish?', 'medicross' ); ?></span>
										</label>
									</span>
								</div>

 ...
 */
function medicross_merlin_import_files() {
	return array(
		array(
			...
			'import_notice'                => esc_html__( 'A special note for this import.', 'medicross' ),
			'preview_url'                  => '//www.example.com/my-demo-1',
		)
	);
}
add_filter( 'merlin_import_files', 'medicross_merlin_import_files' );

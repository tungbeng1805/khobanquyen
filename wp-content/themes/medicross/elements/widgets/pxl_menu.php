...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_menu',
        'title' => esc_html__('Case Nav Menu', 'medicross'),
        'icon' => 'eicon-nav-menu',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'menu',
                            'label' => esc_html__('Select Menu', 'medicross'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => $pxl_menus,
                        ),
                        array(
                            'name' => 'menu_type',
                            'label' => esc_html__('Menu Type', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            'name' => 'text_align',
                            'label' => esc_html__('Text Alignment', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'left' => [
                                    'title' => esc_html__('Left', 'medicross' ),
                ...
                array(
                    ...
                    'label' => esc_html__('First Level', 'medicross'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'p_d',
                            'label' => esc_html__('Divider Position', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                        ...
                        array(
                            'name' => 'color_active',
                            'label' => esc_html__('Color Active', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'arrow_color',
                            'label' => esc_html__('Arrow Color', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Has Children - Font Size', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            'name' => 'item_space1',
                            'label' => esc_html__('Extra Space Bottom', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'flex_grow',
                            'label' => esc_html__('Flex Grow', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'inherit' => [
                                    'title' => esc_html__( 'Inherit', 'medicross' ),
                        ...
                        array(
                            'name' => 'menu_mega_type',
                            'label' => esc_html__('Menu Mega Type', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Left', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Right', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Container Max Width', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                ...
                array(
                    ...
                    'label' => esc_html__('Sub Level', 'medicross'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'sub_color',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Color Hover/Actvie', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'sub_bg_color',
                            'label' => esc_html__('Box Background Color', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Hover/Active Style', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Show Effect', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top - Mega', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [

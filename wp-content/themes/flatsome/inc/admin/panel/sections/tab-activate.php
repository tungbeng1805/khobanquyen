...
?>
  <small style="padding-top: 10px; margin-top: 15px; opacity: .8; display: block; border-top: 1px solid #eee;">Your purchase code (license) is valid for <strong>Multiple Domains</strong>. Do you want to buy a new purchase code? Purchase a <a href="//bit.ly/buy-flatsome" target="_blank">new license here</a> to get a new purchase code. To remove a purchase code simply remove the code and click update.</small>
  </div>
    ...
    <table class="license-table">
     <tbody>
      <tr>
        ...
        <td><?php echo "February 11, 2023" ?></td>
      </tr>
      <tr>
        <td>
        ...
        <td><?php echo "January 10, 2050" ?></td>
      </tr>
      <tr>

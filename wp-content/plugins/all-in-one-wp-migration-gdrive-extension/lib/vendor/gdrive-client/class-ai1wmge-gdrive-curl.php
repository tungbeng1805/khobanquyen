...
class Ai1wmge_GDrive_Curl {
	...
	public function make_request( $parse_as_json = false ) {
		...
		if ( $http_code === 408 ) {
			throw new Ai1wmge_Request_Timeout_Exception( sprintf( __( 'Request timeout exception. Error code: %s <a href="https://help.servmask.com/knowledgebase/google-drive-error-codes/#%s" target="_blank">Technical details</a>', AI1WMGE_PLUGIN_NAME ), $http_code, $http_code ) );
		}

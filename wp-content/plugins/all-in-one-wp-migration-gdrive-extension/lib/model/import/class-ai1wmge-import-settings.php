...
class Ai1wmge_Import_Settings {
	...
	public static function execute( $params ) {
		...
		$settings = array(
			...
			'ai1wmge_gdrive_incremental_folder_id'   => get_option( 'ai1wmge_gdrive_incremental_folder_id', null ),
			...
			'ai1wmge_gdrive_app_folder'              => get_option( 'ai1wmge_gdrive_app_folder', false ),
		);

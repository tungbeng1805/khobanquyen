...
interface WpDiscuzConstants {
    ...
    const GENERATE_THUMBNAILS_ACTION                                                = "wpdiscuz_generate_thumbnails";
    const GENERATE_THUMBNAILS_KEY_RECURRENCE                                        = "wpdiscuz_generate_thumbnails_every_3h";
    const GENERATE_THUMBNAILS_RECURRENCE                                            = 3;
    /* === POST RATING */

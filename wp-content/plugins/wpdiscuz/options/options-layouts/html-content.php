...
<div class="wpd-opt-row" data-wpd-opt="commentTextLength">
    ...
    <div class="wpd-opt-input">
        <span for="commentTextMinLength"><input type="number"
                                                value="<?php echo esc_attr($this->content["commentTextMinLength"]); ?>"
                                                name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[commentTextMinLength]"
                                                id="commentTextMinLength"
                                                style="width:70px;"> <?php esc_html_e("Min", "wpdiscuz") ?> </span>
        <span for="commentTextMaxLength">&nbsp; <input type="number" placeholder="&infin;"
                                                       value="<?php echo esc_attr($this->content["commentTextMaxLength"]); ?>"
                                                       name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[commentTextMaxLength]"
                                                       id="commentTextMaxLength"
                                                       style="width:70px;"> <?php esc_html_e("Max", "wpdiscuz") ?></span>
    </div>
...
<div class="wpd-opt-row" data-wpd-opt="replyTextLength">
    ...
    <div class="wpd-opt-input">
        <span for="replyTextMinLength"><input type="number"
                                              value="<?php echo esc_attr($this->content["replyTextMinLength"]); ?>"
                                              name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[replyTextMinLength]"
                                              id="replyTextMinLength"
                                              style="width:70px;"> <?php esc_html_e("Min", "wpdiscuz") ?> </span>
        <span for="replyTextMaxLength">&nbsp; <input type="number" placeholder="&infin;"
                                                     value="<?php echo esc_attr($this->content["replyTextMaxLength"]); ?>"
                                                     name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[replyTextMaxLength]"
                                                     id="replyTextMaxLength"
                                                     style="width:70px;"> <?php esc_html_e("Max", "wpdiscuz") ?></span>
    </div>
    <div class="wpd-opt-doc">
...
<div class="wpd-opt-row" data-wpd-opt="enableImageConversion">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->content["enableImageConversion"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[enableImageConversion]"
                   id="enableImageConversion">
...
<div class="wpd-opt-row" data-wpd-opt="enableShortcodes">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->content["enableShortcodes"] == 1) ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[enableShortcodes]" id="enableShortcodes">
...
<div class="wpd-opt-row" data-wpd-opt="commentReadMoreLimit">
    ...
    <div class="wpd-opt-input">
        <input type="number" value="<?php echo esc_attr($this->content["commentReadMoreLimit"]); ?>"
               name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[commentReadMoreLimit]" id="commentReadMoreLimit"
               style="width:100px;"/>
    </div>
    <div class="wpd-opt-doc">
...
<div class="wpd-opt-row" data-wpd-opt="wmuIsEnabled">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->content["wmuIsEnabled"] == 1); ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[wmuIsEnabled]" id="wmuIsEnabled">
...
<div class="wpd-opt-row" data-wpd-opt="wmuIsGuestAllowed">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->content["wmuIsGuestAllowed"] == 1); ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[wmuIsGuestAllowed]" id="wmuIsGuestAllowed">
...
<div class="wpd-opt-row" data-wpd-opt="wmuIsLightbox">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->content["wmuIsLightbox"] == 1); ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[wmuIsLightbox]" id="wmuIsLightbox">
    ...
    <div class="wpd-opt-input" style="width: 100%; margin-top: 10px;">
        ...
        foreach ($mimes as $ext => $mime) {
            ...
            <div class="wpd-mublock-inline wpd-mu-mimes" style="margin-right: 2px;">
                <input type="checkbox" <?php checked(isset($this->content["wmuMimeTypes"][$ext]) && $this->content["wmuMimeTypes"][$ext] === $mime); ?>
                       value="<?php echo esc_attr($mime); ?>"
                       name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[wmuMimeTypes][<?php echo esc_attr($ext); ?>]"
                       id="wmu-<?php echo esc_attr($ext); ?>" style="margin:0px; vertical-align: middle;"/>
                <label for="wmu-<?php echo esc_attr($ext); ?>" title="<?php echo esc_attr($ext); ?>"
                       style="white-space:nowrap; font-size:13px;"><?php echo esc_html($ext); ?></label>
            </div>
            <?php
        }
        ?>
        ...
        <div style="margin-top:10px;">
            <button id="wmuSelectMimes" type="button"
                    class="button button-secondary"><?php esc_html_e("Select All", "wpdiscuz"); ?></button>
            <button id="wmuUnselectMimes" type="button"
                    class="button button-secondary"><?php esc_html_e("Unselect All", "wpdiscuz"); ?></button>
            <button id="wmuInvertMimes" type="button"
                    class="button button-secondary"><?php esc_html_e("Invert Selection", "wpdiscuz"); ?></button>
        </div>
    </div>
</div>
<!-- Option end -->
...
<div class="wpd-opt-row" data-wpd-opt="wmuMaxFileSize">
    ...
    <div class="wpd-opt-input">
        <input step="any" type="number" value="<?php echo esc_attr($this->content["wmuMaxFileSize"]); ?>"
               name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[wmuMaxFileSize]" id="wmuMaxFileSize"
...
<div class="wpd-opt-row" data-wpd-opt="wmuIsShowFilesDashboard">
    ...
    <div class="wpd-opt-input">
        <div class="wpd-switcher">
            <input type="checkbox" <?php checked($this->content["wmuIsShowFilesDashboard"] == 1); ?> value="1"
                   name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[wmuIsShowFilesDashboard]"
                   id="wmuIsShowFilesDashboard">
...
<div class="wpd-opt-row" data-wpd-opt="wmuSingleImageSize">
    ...
    <div class="wpd-opt-input">
        <input type="text" value="<?php echo esc_attr($this->content["wmuSingleImageWidth"]); ?>"
               name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[wmuSingleImageWidth]" id="wmuSingleImageWidth"
               class="wmu-number wmu-image-dimension wmu-image-width"
               style="width: 80px;"/><span> <?php esc_html_e("Width (px)", "wpdiscuz"); ?> </span><br>
        <input type="text" value="<?php echo esc_attr($this->content["wmuSingleImageHeight"]); ?>"
               name="<?php echo esc_attr(WpdiscuzCore::TAB_CONTENT); ?>[wmuSingleImageHeight]" id="wmuSingleImageHeight"
               class="wmu-number wmu-image-dimension wmu-image-height"
               style="width: 80px;"/><span> <?php esc_html_e("Height (px)", "wpdiscuz"); ?> </span>
    </div>
    <div class="wpd-opt-doc">
